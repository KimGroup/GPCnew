...
class DirichletGPModel(ExactGP):
    ...
    def forward(self, x):
        ...
        covar_x = self.covar_module_ard(x)
...
def cluster_lengthscales(model, thresh_pct=0.15):
    ...
    estimated_covar = torch.diag(torch.squeeze(model.covar_module_ard.lengthscale.reciprocal() ** 2))
...
for d in range(72,71,-1):
    ...
    for i in range(30):
        ...
        with gpytorch.settings.max_cholesky_size(2000):
            ...
            rmatrix= cluster_lengthscales(model)
